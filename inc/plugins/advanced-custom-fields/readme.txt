...
* Taxonomy field: Add new filter for wp_list_categories defaults - http://support.advancedcustomfields.com/forums/topic/taxonomy-field-type-filter-to-only-show-parents/
